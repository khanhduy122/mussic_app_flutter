...
class ContainerTopMussic extends StatefulWidget {
  ...
  @override
  State<ContainerTopMussic> createState() => _ContainerTopMussicState();
}

class _ContainerTopMussicState extends State<ContainerTopMussic> {
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        ...
                        style: widget.position == 1 ? const TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: 40)
                        : widget.position == 2 ? const TextStyle(color: Colors.green, fontWeight: FontWeight.bold, fontSize: 35):
                        widget.position == 3 ? const TextStyle(color: Colors.red, fontWeight: FontWeight.bold, fontSize: 30):
