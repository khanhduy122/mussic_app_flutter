...
class _SearchScreenState extends State<SearchScreen> {
    ...
    final PlayMussicBloc _getResultSearch = PlayMussicBloc();
    ...
    return BlocListener<PlayMussicBloc, PlayMussicState>(
      ...
      listener: (context, state) {
        ...
        if(state.search != null){
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) =>  ResultSearchScreen(keySearch: _textController.text, search: state.search!,),));
          addKeySearch();
        }

        if(state.erro != null){
          Navigator.pop(context);
          appDiaLog.showDialogNotify(content: "Vui lòng kiểm tra lại đường truyền Internet", context: context);
        }
      },
      child: Scaffold(
                              ...
                              GestureDetector(
                                onTap: () async{
                                  if(_textController.text.isNotEmpty) {
                                    _getResultSearch.add(getResultSearchEvent(keySearch: _textController.text));
                                  }
                                },
                                child: Container(
