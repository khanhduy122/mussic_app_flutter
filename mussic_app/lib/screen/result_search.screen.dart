...
import 'package:mussic_app/model/netword.dart';
...
class ResultSearchScreen extends StatefulWidget {
  const ResultSearchScreen({super.key, required this.stringSearch});
...
class _ResultSearchScreenState extends State<ResultSearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<PlayMussicBloc, PlayMussicState>(
      ...
      child: BlocListener<PlayMussicBloc, PlayMussicState>(
          ...
          child: Scaffold(
              body: FutureBuilder(
                future: NetwordRequest.fetchSearch(http.Client(), widget.stringSearch),
                        ...
                        child: Column(
                          children: [
                                          ...
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                initialValue: widget.stringSearch,
                            ...
                            Expanded(
                              child: TabBarView(
                                children: [
                                  allResultSearch(snapshot.data!, _pageControllerMV),
                                  AllSongs(snapshot.data!),
                                  AllArtist(snapshot.data!),
                                  AllPlaylist(snapshot.data!),
                                  allMV(snapshot.data!),
                                ]
                              ),
                            )
            ...
            onTap: (){
              if(search.topArtist != null){
                ...
                if(search.topPlaylist != null){
                  _getPlayList.add(getInfoPlayListEvent(encodeId: search.topPlaylist!.encodeId! ));
                }else{
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          (search.artists![0].totalFollow!.toString().length >= 4 && search.artists![0].totalFollow.toString().length < 7 ? '${(search.artists![0].totalFollow! / 1000).toInt()}K Quan Tâm' : search.artists![0].totalFollow!.toString().length < 4 ? '${search.artists![0].totalFollow}Quan Tam' :  ((search.artists![0].totalFollow! / 1000000).toStringAsFixed(1))+ 'M Quan Tâm')
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ContainerPlayListHot(
                  ...
                  axis: Axis.vertical,
                  ontap: (){
                    _getPlayList.add(getInfoPlayListEvent(encodeId: search.playlists![index].encodeId!));
                  },
                );
              },
            ),
          ...
          search.videos != null ? SizedBox(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                return ContainerMV(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => PlayMvScreen(mv: search.videos![index]),));
                  },
  ...
  Widget AllSongs(Search search){
    return search.songs != null ? Column(
      children: [
  ...
  Widget AllPlaylist(Search search){
    ...
    Column(
      children: [
        const SizedBox(height: 20,),
        SizedBox(
          height: search.playlists!.length * 80,
          child: ListView.builder(
            shrinkWrap: true,
